...
extend(Chart.prototype, {
  ...
  exportChart: function (options, chartOptions) {
	...
	// add the values
	each(['type', 'svg', 'communityId', 'dataset', 'scenario', 'variability','units','baseline','resolution'], function(name) {
		createElement('input', {
			type: HIDDEN,
			name: name,
			value: {
				...
				units: window.snapCharts.data.units,
				baseline: window.snapCharts.data.baseline,
				resolution: window.snapCharts.data.resolution
			}[name]
		}, null, form);
	});
